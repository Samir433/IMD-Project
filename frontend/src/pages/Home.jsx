        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">UV radiation guidance for public well-being and safety measures.</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Optimize solar energy planning and resource management.</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <span className="text-2xl flex-shrink-0">🌾</span>
            <div>
              ...
              <p className="text-gray-400 text-sm">Support smart farming practices and climate-adaptive strategies.</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <span className="text-2xl flex-shrink-0">🔬</span>
            <div>
              ...
              <p className="text-gray-400 text-sm">Advance atmospheric science and climate modeling research.</p>
            </div>
          </div>
        </div>
      </div>
